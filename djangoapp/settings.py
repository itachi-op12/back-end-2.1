...
SECRET_KEY = 'django-insecure-a+=7ry-$tju-khtqldq&f+lidd^*#v=f%ri4(uj!(&(@+f-(#i'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
CSRF_TRUSTED_ORIGINS = ['https://8000-firebase-trabalho-20-1755007160659.cluster-ve345ymguzcd6qqzuko2qbxtfe.cloudworkstations.dev/admin']
